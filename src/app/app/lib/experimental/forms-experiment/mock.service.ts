...
export class MockService {
  ...
  selectTvs(): Observable<IProduct[]> {
    return of([
      ...
      {typeProduct: 'POP', nameProduct: 'POP-панель (плазма)', noWarranty: true},
      {typeProduct: 'ELT', nameProduct: 'ЭЛТ-телевизор (кинескоп)', noWarranty: true},
    ])
  }
  ...
  warrantyPeriod(): Observable<IWarranty[]> {
    return of([
      ...
      {typeWarranty: 'none', nameWarranty: 'Гарантия отсутствует', noWarranty: true}
    ])
